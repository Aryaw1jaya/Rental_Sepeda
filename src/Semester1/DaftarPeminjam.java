...
public class DaftarPeminjam extends javax.swing.JFrame {
    ...
    private void tampilkan_data(){
        String perintah="SELECT * FROM data_peminjam";
        
        try {
            pst = conn.prepareStatement(perintah);
            rs = pst.executeQuery();
            DefaultTableModel t_peminjam = new DefaultTableModel();
            t_peminjam.addColumn("id_peminjam");
            t_peminjam.addColumn("nomor_ktp");
            t_peminjam.addColumn("nama_peminjam");
            t_peminjam.addColumn("hp_peminjam");
            t_peminjam.addColumn("alamat peminjam");
